...
type SecKillProduct struct {
	...
	ProductName string `orm:"unique;size(60);default('')" form:"ProductName"  valid:"Required"`//商品id
	Total       int    `orm:"size(10);default(0)" form:"Total" valid:"Min(0)"`//商品名称
	Status      int    `orm:"default(2)" form:"Status" valid:"Range(1,2)"`//商品状态（1.上架,2.下架）
}
