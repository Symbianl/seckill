...
func (this *ActivityController) getDataFormHtml() (activity models.SecKillActivity, err error) {
	...
	fmt.Println("aaaaa:",receiveStartTime)

	//
	//StartTime, err0 := time.ParseInLocation("2006-01-02 15:04:05", receiveStartTime, local)
	StartTime, err := time.Parse("2006-01-02 15:04:05", receiveStartTime)
	if err != nil {
	...
	//EndTime, err := time.ParseInLocation("2006-01-02 15:04:05", receiveEndTime, local)
	EndTime, err := time.Parse("2006-01-02 15:04:05", receiveEndTime)
